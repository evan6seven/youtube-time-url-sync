...
- Kick VOD behavior: On `/.../videos/...` pages, the userscript unmutes the player, closes the chat sidebar, and enables theater mode on page load/navigation. The sync button must not toggle chat or theater mode.
